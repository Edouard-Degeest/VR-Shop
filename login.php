...
<div class="card-body">
  ...
  <form action="" method="POST">
    ...
    <button type="submit" id="button" name="submit" class="btn btn-primary deep-purple btn-block ">Connexion</button>
    <br>
    <p type="text">Nouveau chez nous ?<br><br><a href="register.php">Créer un compte</p></a>
<br>
    <br>
  </form>
</div>
